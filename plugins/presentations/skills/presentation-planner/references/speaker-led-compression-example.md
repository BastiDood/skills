# Speaker-Led Compression and Idea Clustering
...
- AI tools only intensify the work now that we can delegate the tedious parts away...
- The biggest paradox in this post-AI world is
...
It creates one slide per paragraph, mirrors full note sentences, treats a clipped sentence plus ellipsis as compression, and uses a sentence prefix that does not express a complete concept. The three source groups make one cumulative audience point and share one visual state, so one compact slide can support the entire scripted passage.

</why_the_anti_example_fails>

<rule_demonstrated>

Cluster several chained source groups when they share one audience task and visual frame. Preserve the complete script in presenter notes while reducing the slide to terse cues that the presenter expands aloud.
